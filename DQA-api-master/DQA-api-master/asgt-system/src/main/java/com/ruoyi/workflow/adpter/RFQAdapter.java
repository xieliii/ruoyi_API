...
@Service
@ProcessKey("RFQ")
public class RFQAdapter extends AbstractBusinessOperationAdapter<ApprovedRequirementDTO> {
    ...
    public List<AgWorkflowAssigneeEntity> saveWorkflowAssignee(List<UserTask> list) {
        ...
        nodeAndAssigneeMap.put(ProcessConstant.RFQ_NODE_ONE,String.valueOf(userId));
        ...
        nodeAndAssigneeMap.put(ProcessConstant.RFQ_NODE_THREE,String.valueOf(userId));
        nodeAndAssigneeMap.put(ProcessConstant.RFQ_NODE_FOUR,String.valueOf(sysDept.getLeader()));
        nodeAndAssigneeMap.put(ProcessConstant.RFQ_NODE_FIVE,String.valueOf(userId));
