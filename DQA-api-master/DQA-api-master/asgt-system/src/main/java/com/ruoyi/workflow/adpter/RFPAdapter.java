...
@Service
@ProcessKey("RFP")
public class RFPAdapter extends AbstractBusinessOperationAdapter<ApprovedRequirementDTO> {
    @Resource
    ...
    public ApprovedRequirementDTO saveBusinessData(ProcessStartAdapterDto<ApprovedRequirementDTO> startAdapterDto) {
        Assert.notNull(startAdapterDto, ProcessConstant.NOT_EXIST);
        ApprovedRequirementDTO businessData = startAdapterDto.getBusinessData();
    ...
    public List<AgWorkflowAssigneeEntity> saveWorkflowAssignee(List<UserTask> list) {
        ...
        nodeAndAssigneeMap.put(ProcessConstant.RFP_NODE_ONE,String.valueOf(userId));
        ...
        nodeAndAssigneeMap.put(ProcessConstant.RFP_NODE_THREE,String.valueOf(userId));
        nodeAndAssigneeMap.put(ProcessConstant.RFP_NODE_FOUR,String.valueOf(sysDept.getLeader()));
        nodeAndAssigneeMap.put(ProcessConstant.RFP_NODE_FIVE,String.valueOf(userId));
