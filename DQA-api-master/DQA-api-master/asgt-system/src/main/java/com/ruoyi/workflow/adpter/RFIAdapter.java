...
@Service
@ProcessKey("RFI")
public class RFIAdapter extends AbstractBusinessOperationAdapter<ApprovedRequirementDTO> {
    @Resource
    ...
    public List<AgWorkflowAssigneeEntity> saveWorkflowAssignee(List<UserTask> list) {
        ...
        nodeAndAssigneeMap.put(ProcessConstant.RFI_NODE_ONE,String.valueOf(userId));
        ...
        nodeAndAssigneeMap.put(ProcessConstant.RFI_NODE_THREE,String.valueOf(userId));
        nodeAndAssigneeMap.put(ProcessConstant.RFI_NODE_FOUR,String.valueOf(sysDept.getLeader()));
        nodeAndAssigneeMap.put(ProcessConstant.RFI_NODE_FIVE,String.valueOf(userId));
